      ...
      <div className="w-full max-w-md">
        ...
        {process.env.NODE_ENV !== "production" && (
          <div className="mt-10 border-t border-[color:var(--rule)] pt-6">
            <p className="eyebrow mb-3">Demo accounts · dev only</p>
            <p className="text-xs text-ink-mute mb-4 leading-[1.55]">
              These accounts are seeded in non-production environments only.
              They will not exist on the production deployment.
            </p>
